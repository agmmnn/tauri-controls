...
export const Icons = {
  minimizeWin: (props: ComponentProps<"svg">) => (
  ...
  minMac: (props: ComponentProps<"svg">) => (
  ...
  fullMac: (props: ComponentProps<"svg">) => (
  ...
  plusMac: (props: ComponentProps<"svg">) => (
