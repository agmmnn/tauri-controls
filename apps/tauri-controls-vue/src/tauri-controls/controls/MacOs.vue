...
import { closeWindow, minimizeWindow, maximizeWindow, fullscreenWindow } from '../utils/window';
...
<template>
    <div ref="winBtns" :class="twMerge('px-2 text-black active:text-black dark:text-black', $attrs.class as string)">
        ...
        <Button @click="isAltKeyPressed ? maximizeWindow() : fullscreenWindow()"
